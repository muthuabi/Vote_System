                ...
                .done(function (data) {
                    ...
                    data.data.forEach(values => {
                        ...
                        if (document.querySelector(`#can${values.candidate_id}`)) {
                            ...
                            if(data.max_post_data[values.post_id] && (data.max_post_data[values.post_id].max_candidate_id==values.candidate_id) || (values.post=="Chairman" || values.post=="Join Secretary" ))
                            {
